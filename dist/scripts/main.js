...
// scripts/config.ts
var HOME_LOCATION_SCOREBOARD = "HOME_LOCATION";
var WORLD_CONFIG_SCOREBOARD = "WORLD_CONFIG";
var WorldConfigs = {
  TP_ENABLE: 1,
  // Enable .tp
  TP_CLEAR_LEVELS_AMOUNT: 3,
  // Levels to remove on tp
  HOME_ENABLE: 1
  // Enable .home
};
...
function processCustomCommands(eventData) {
...
// scripts/main.ts
system.run(mainLoop);
world2.beforeEvents.chatSend.subscribe(onPlayerChatSend);
