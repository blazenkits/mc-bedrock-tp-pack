...
export var Commands;
(function (Commands) {
    Commands[Commands["INVALID"] = 0] = "INVALID";
    Commands[Commands["TP"] = 1] = "TP";
    Commands[Commands["SETHOME"] = 2] = "SETHOME";
    Commands[Commands["HOME"] = 3] = "HOME";
    Commands[Commands["RESTART"] = 4] = "RESTART";
    Commands[Commands["SHOWERR"] = 5] = "SHOWERR";
    Commands[Commands["BACK"] = 6] = "BACK";
})(Commands || (Commands = {}));
export function getCommand(tag) {
    switch (tag) {
        case ".home":
        case "!home":
...
export function processCustomCommands(eventData) {
        ...
        switch (eventData.command) {
            ...
            case Commands.HOME: {
                ...
                if (px != undefined && py != undefined && pz != undefined) {
                    setLastTPPosition(player);
                    let tpSuccess = player.tryTeleport({ x: px, y: py, z: pz }, { dimension: world.getDimension(MinecraftDimensionTypes.Overworld) });
                    if (tpSuccess) {
                        player.addLevels(-config.WorldConfigs.TP_CLEAR_LEVELS_AMOUNT);
                        if (player.level < 0) {
                            player.resetLevel();
...
function setLastTPPosition(player) {
